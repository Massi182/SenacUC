...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
       try {
        int idProduto = Integer.parseInt(id_produto_venda.getText().trim()); // Obtém o ID digitado
        ...
        JOptionPane.showMessageDialog(this, "❌ Digite um número válido no campo ID.");
    } catch (Exception e) {
